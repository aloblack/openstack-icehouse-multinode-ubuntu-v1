...
sleep 3
neutron subnet-create --name sub_ext_net ext_net 10.1.14.0/23 --gateway 10.1.14.1 --allocation-pool start=10.1.15.100,end=10.1.15.250 --enable_dhcp=False --dns-nameservers list=true 8.8.8.8 8.8.4.4 210.245.0.11
